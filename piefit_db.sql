...
create table setting (
  settingid serial,
  theme enum('Standard', 'Accessibility') not null default 'Standard',
  -- Needs Theme names
...
insert into
  box
values('HOME EDITION', 2.8, false);
insert into
  box
values('HIIT EDITION', 2.5, false);
insert into
  box
values('POWER EDITION', 3.6, false);
...
insert into
  collection
values('HOME EDITION', 'CORE', 5, false);
insert into
  collection
values('HOME EDITION', 'LOWERBODY', 5, false);
insert into
  collection
values('HOME EDITION', 'UPPERBODY', 5, false);
insert into
  collection
values('HOME EDITION', 'FULLBODY', 5, false);
insert into
  collection
values('HIIT EDITION', 'CORE', 5, false);
insert into
  collection
values('HIIT EDITION', 'LOWERBODY', 5, false);
insert into
  collection
values('HIIT EDITION', 'UPPERBODY', 5, false);
insert into
  collection
values('HIIT EDITION', 'FULLBODY', 5, false);
insert into
  collection
values('POWER EDITION', 'CORE', 5, false);
insert into
  collection
values('POWER EDITION', 'LOWERBODY', 5, false);
insert into
  collection
values('POWER EDITION', 'UPPERBODY', 5, false);
insert into
  collection
values('POWER EDITION', 'FULLBODY', 5, false);
-- Create card table
...
create table exercise (
    ...
    -- Unsure about syntax for videos
