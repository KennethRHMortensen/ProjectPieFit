...
create table user (
	...
	theme enum('Standard', 'Dark mode') not null default 'Standard', -- More themes can be added later --flyttet nml
...
insert into user values(null, 'Admin', 'admin@email.dk', '1234', true, 'Standard', 'John Doe', 'Male', 'I''m so cool');
insert into user values(null, 'User', 'user@email.dk', '1234', false, 'Standard', 'Jane Doe', 'Female', 'I''m so cool');
...
create table image (
	...
	image blob not null, -- Unsure about syntax for images   skal være blob
	primary key(imageid),
